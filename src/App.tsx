...
function Site() {
  ...
  return <div className="site-shell"><div className="sticky-group"><Ticker /><Header onMenu={() => setMenuOpen(!menuOpen)} menuOpen={menuOpen} /></div><Routes><Route path="/admin" element={<Admin />} /><Route path="/" element={<Home />} /><Route path="/membership" element={<MembershipPage />} /><Route path="/blood-donation" element={<FormPage type="bloodDonation" />} /><Route path="/overseas-registration" element={<FormPage type="overseasRegistration" />} /><Route path="/:type" element={<CollectionPage />} /></Routes><Footer /></div>;
}
