...
function Home() {
  const [news, setNews] = useState<RecordItem[]>([]); const [overseas, setOverseas] = useState<RecordItem[]>([]); const [ads, setAds] = useState<RecordItem[]>([]); const [copiedAccount, setCopiedAccount] = useState('');
