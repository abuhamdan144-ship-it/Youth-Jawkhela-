...
export function MembershipCardDemo() {
  ...
  return <main className="card-demo"><div className="container"><div className="card-demo__heading"><span className="eyebrow">Approved Gemini concept · two-sided</span><h1>Normal 3D member card</h1><p>Approved white, forest-green, and gold plastic ID-card design for private Zwanan Jawkhela community membership. This is not a government CNIC.</p></div><div className="gemini-card-preview"><div><img src="/member-card-gemini-front.png" alt="Approved Gemini membership card front design" /><h2>Front side</h2></div><div><img src="/member-card-gemini-back.png" alt="Approved Gemini membership card back design" /><h2>Back side</h2></div></div><div className="card-demo__grid"><div><MembershipCard member={member} variant="midnight" demo /><h2>Live dynamic card preview</h2><p>The live preview and Admin Card download use the same white, green, gold, two-sided private ID-card direction with each member’s own details.</p></div></div></div></main>;
}
